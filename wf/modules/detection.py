...
class Module(pl.LightningModule):
    ...
    def frequency_consistency_loss(pred_freq, target_freq, alpha=0.1):
        """频域一致性损失"""
        pred_fft = torch.fft.rfft2(pred_freq, norm='ortho')
        target_fft = torch.fft.rfft2(target_freq, norm='ortho')
